package com.Mindtree.HospitalManagment.controller;

import java.net.URI;
import java.util.List;
import com.Mindtree.HospitalManagment.entity.Doctor;
import com.Mindtree.HospitalManagment.repository.DoctorRepository;
import com.fasterxml.jackson.databind.ser.FilterProvider;
import com.fasterxml.jackson.databind.ser.impl.SimpleBeanPropertyFilter;
import com.fasterxml.jackson.databind.ser.impl.SimpleFilterProvider;
import com.Mindtree.HospitalManagment.service.HospitalService;
...
public class DoctorController {
	...
	public Doctor getDoctorInfo(@PathVariable String name) {
		Doctor doc=service.showDoctorInformation(name);
		return doc;
	}
